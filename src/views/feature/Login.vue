      ...
      <div class="login-form-wrap">
        ...
        >
          ...
          <el-form-item prop="username" label="用户名">
            ...
            >
              <template #prefix>
                <svg-icon name="user1" class="input-icon" />
              </template>
            </el-input>
          </el-form-item>
          <el-form-item prop="password" label="密码">
            ...
            >
              <template #prefix>
                <svg-icon name="password1" class="input-icon" />
              </template>
            </el-input>
          </el-form-item>
          <el-form-item>
            <el-checkbox class="rememberMe" v-model="loginForm.rememberMe"
              >记住密码</el-checkbox
            >
          </el-form-item>
  ...
  .login-wrap {
    ...
    .login-form-wrap {
      ...
      .login-logo {
        width: 620px;
        height: 640px;
        background: url("@/assets/images/login/login-logo.png") no-repeat center
          center;
        background-size: cover;
      }
      .login-form {
